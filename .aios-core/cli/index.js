...
const { createTelemetryCommand } = require('./commands/telemetry');
...
Commands:
  ...
  telemetry         Execution telemetry (show, report, dashboard, backfill, cleanup)
...
`);
  ...
  // Add telemetry command (feature/telemetry)
